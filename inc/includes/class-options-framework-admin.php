...
class Options_Framework_Admin {
    ...
    public function init() {
    	...
    	if ( $options ) {
			...
			add_action( 'admin_menu', array( $this, 'add_dashboard_options_page' ) );
	...
	static function menu_settings() {
		...
		$menu = array(
			'page_title' => esc_html__( 'Theme Options', 'awesome' ),
			'menu_title' => esc_html__( 'Theme Options', 'awesome' ),
     ...
     * @since 1.7.0
     */
	function add_dashboard_options_page() {
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'awesome' ); ?>" />
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'awesome' ); ?>" onclick="return confirm( '<?php print esc_js( esc_html__( 'Click OK to reset. Any theme settings will be lost!', 'awesome' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'options-framework', 'restore_defaults', esc_html__( 'Default options restored.', 'awesome' ), 'updated fade' );
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', esc_html__( 'Options saved.', 'awesome' ), 'updated fade' );
	}
	...
	function optionsframework_admin_bar() {
		...
		$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => esc_html__( 'Theme Options', 'awesome' ),
