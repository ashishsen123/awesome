...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__( 'No Repeat', 'awesome' ),
		'repeat-x'  => esc_html__( 'Repeat Horizontally', 'awesome' ),
		'repeat-y'  => esc_html__( 'Repeat Vertically', 'awesome' ),
		'repeat'    => esc_html__( 'Repeat All', 'awesome' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'awesome' ),
		'top center'    => esc_html__( 'Top Center', 'awesome' ),
		'top right'     => esc_html__( 'Top Right', 'awesome' ),
		'center left'   => esc_html__( 'Middle Left', 'awesome' ),
		'center center' => esc_html__( 'Middle Center', 'awesome' ),
		'center right'  => esc_html__( 'Middle Right', 'awesome' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'awesome' ),
		'bottom center' => esc_html__( 'Bottom Center', 'awesome' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'awesome')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'awesome' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'awesome')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__( 'Normal', 'awesome' ),
		'italic'      => esc_html__( 'Italic', 'awesome' ),
		'bold'        => esc_html__( 'Bold', 'awesome' ),
		'bold italic' => esc_html__( 'Bold Italic', 'awesome' )
		);
