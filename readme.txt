...
Donate link: http://awesometheme.com
...
Awesome is your basic building block for creating beautiful, responsive custom themes. It's not a convoluted or confusing framework that's hard to learn or even harder to modify. It's a simple and elegant starter theme built on HTML5 & CSS3. Its base is a responsive, 12 column grid. It incorporates custom Theme Options that are easy to modify, a set of common templates, support for WordPress Post Formats and the gorgeous, retina friendly Font Awesome icon font.


== Description ==

Awesome is your basic building block for creating beautiful, responsive custom themes. It's not a convoluted or confusing framework that's hard to learn or
...
The main navigation uses the standard WordPress menu. Support for dropdown menus is inluded by default. If you'd like to envoke a button toggle for the main navigation menu on small screens, simply uncomment the two lines from the awesome_scripts_styles() function within functions.php to register and enqueue the necessary javascript file, and BAM! You're done!

Templates

Awesome includes a set of your most common theme templates, including templates for Full-Width pages, Left Sidebar, Right Sidebar (default), Front-Page, Tag,
...
Widgets are a great way of adding extra content to your site and Awesome has a whole assortment of them.
...
Use the following instructions to install & activate Awesome using your preferred method.

Manual installation:

1. Unzip the files from the Awesome zip file that you downloaded
2. Upload the Awesome folder to your /wp-content/themes/ directory
3. Click on the Appearance > Themes menu option in the WordPress Dashboard
4. Click the Activate link below the Awesome preview thumbnail
...
3. Type 'Awesome' in the search field, without the quotes, and then click the Search button
4. Click the Install Now link below the Awesome preview thumbnail
...
Since Awesome is a starter theme to kick off your own awesome theme, the first thing you want to do is copy the awesome theme folder 
...
1. Search for awesome inside single quotations to capture the text domain.
2. Search for awesome_ to capture all the function names.
3. Search for awesome with a space before it to replace all the occurrences of it in comments.
...
Awesome is licensed under the [GNU General Public License version 2](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html).
...
Awesome utilises the following awesomeness:
